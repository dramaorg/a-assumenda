[![test-go](https://github.com/dramaorg/a-assumenda/actions/workflows/test-go.yml/badge.svg)](https://github.com/dramaorg/a-assumenda/actions/workflows/test-go.yml)
[![test-java](https://github.com/dramaorg/a-assumenda/actions/workflows/test-java.yml/badge.svg)](https://github.com/dramaorg/a-assumenda/actions/workflows/test-java.yml)
[![test-javascript](https://github.com/dramaorg/a-assumenda/actions/workflows/test-javascript.yml/badge.svg)](https://github.com/dramaorg/a-assumenda/actions/workflows/test-javascript.yml)
[![test-python](https://github.com/dramaorg/a-assumenda/actions/workflows/test-python.yml/badge.svg)](https://github.com/dramaorg/a-assumenda/actions/workflows/test-python.yml)
[![test-ruby](https://github.com/dramaorg/a-assumenda/actions/workflows/test-ruby.yml/badge.svg)](https://github.com/dramaorg/a-assumenda/actions/workflows/test-ruby.yml)
[![test-dotnet](https://github.com/dramaorg/a-assumenda/actions/workflows/test-dotnet.yml/badge.svg)](https://github.com/dramaorg/a-assumenda/actions/workflows/test-dotnet.yml)
...
[Cucumber Expression - Java Heuristics](https://github.com/dramaorg/a-assumenda/blob/main/java/heuristics.adoc).
